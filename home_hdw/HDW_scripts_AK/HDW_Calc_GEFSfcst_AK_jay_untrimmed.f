	! FORTRAN code to read GEFS forecast files and compute HDWI for a single day for AK
	!     Assumes we are using 18, 21, 00, 03, 06, and 09 times for AK
	!
	...
	!  First, read in all the necesary variables from GEFS files for 1800, 2100, 0000, 0300, 0600, and 0900 
	!     (next day)
