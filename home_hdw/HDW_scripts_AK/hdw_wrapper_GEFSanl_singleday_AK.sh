...
echo "GEFS_06.grib2" >> namelist.inp
echo "FILE_18.inv" >> namelist.inp
echo "FILE_00.inv" >> namelist.inp
echo "FILE_06.inv" >> namelist.inp
...
# 06z data...
#wget -nv -O gefs_a_c06_000.grib2 https://nomads.ncep.noaa.gov/pub/data/nccf/com/gens/prod/gefs.${yyyy2}${mm2}${dd2}/06/atmos/pgrb2ap5/gec00.t06z.pgrb2a.0p50.f000
#wget -nv -O gefs_b_c06_000.grib2 https://nomads.ncep.noaa.gov/pub/data/nccf/com/gens/prod/gefs.${yyyy2}${mm2}${dd2}/06/atmos/pgrb2bp5/gec00.t06z.pgrb2b.0p50.f000
...
gfortran -fopenmp HDW_Calc_GEFS_singleday_AK.f -o HDW_Calc_GEFS_singleday_AK.exe -L/home/ubuntu/grib2/lib -lwgrib2 -lgfortran -lz -lm  -I/home/ubuntu/grib2/lib
./HDW_Calc_GEFS_singleday_AK.exe < namelist.inp > data.cdl
...
cat HDWI_header_AK.cdl data2.cdl > out.cdl
ncgen -o GEFS_HDW_AK_ANL.nc out.cdl

rm gefs_a*.grib2 gefs_b*.grib2 FILE*.inv GEFS_18.grib2 GEFS_00.grib2 GEFS_06.grib2 namelist.inp data.cdl out.cdl data2.cdl HDW_Calc_GEFS_singleday_AK.exe

cp GEFS_HDW_AK_ANL.nc /home/ubuntu/HDW_data_AK/pastANL/GEFS_HDW_ANL_${yyyy}${mm}${dd}_AK.nc
mv GEFS_HDW_AK_ANL.nc /home/ubuntu/HDW_data_AK/GEFS_HDW_ANL_AK_day-1.nc
