...
echo "GEFS_09.grib2" >> namelist.inp
...
cat HDWI_header_AK.cdl data2.cdl > out${iday}_${pnum}.cdl
...
ncecat out?.nc GEFS_HDW_FCST_AK.nc
ncrename -h -d record,day GEFS_HDW_FCST_AK.nc

# Clean up the mess...
rm out*.cdl out*.nc HDW_Calc_GEFS_singleday_AK.exe

cp GEFS_HDW_FCST_AK.nc /home/ubuntu/HDW_data_AK/pastFCST/GEFS_HDW_FCST_${yyyy}${mm}${dd}_AK.nc
mv GEFS_HDW_FCST_AK.nc /home/ubuntu/HDW_data_AK/
